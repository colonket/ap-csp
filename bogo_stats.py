...
if __name__ == '__main__':
    try:
        ...
        minListSize = int(sys.argv[2])
        maxListSize = int(sys.argv[3])+1
    except:
    ...
    for i in range(minListSize,maxListSize):
        ...
        print("Average sort time for",len(numList),"elements:","{0:.10f}".format(sum(averages)/len(averages)),"seconds for",len(averages),"samples")
        print()
